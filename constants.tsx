...
export const ItemsIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M4 15h6" />
    <path d="M7 12v6" />
    <path d="M4 21V9a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v12Z" />
    <path d="M14 21V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v16Z" />
  </svg>
);
...
export const AnimatedCheckIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52">
        ...
        <path className="stroke-current text-green-600 dark:text-green-400" fill="none" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" d="M14 27l5.917 4.917L38 18">
...
export const OfflineIcon: React.FC<{ className?: string, title?: string }> = ({ className, title }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <title>{title}</title>
        <path d="M18.36 6.64A9 9 0 0 1 22.3 11.2m-4.24 4.24A9 9 0 0 1 6.64 18.36m-4.02.38a9 9 0 0 1 0-12.72m4.02-1.28A9 9 0 0 1 12 2.05"/>
...
export const PaintBrushIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M9.064 2.342 5 6.406" />
      <path d="m14.32 1.649 3.535 3.535-2.121 2.122-3.536-3.536z" />
      <path d="M12 12.023 6.407 17.62a2.025 2.025 0 0 0 2.863 2.863L14.909 15" />
      <path d="M12 12.023 2.343 21.68" />
    </svg>
);
...
export const RefundIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M15 9.5H2.7a.5.5 0 0 0-.5.5v4a.5.5 0 0 0 .5.5h12.3c.3 0 .5-.2.5-.5v-4a.5.5 0 0 0-.5-.5Z"/>
      <path d="M3 14.5v-5"/>
      <path d="M21.2 12H19"/>
      <path d="m16.8 7.3-1 1"/>
      <path d="m16.8 16.7-1-1"/>
      <path d="m12 5.8 1-1"/>
      <path d="m12 18.2 1-1"/>
    </svg>
);
...
export const SplitIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="m15 9-3-3" />
    <path d="M21 21l-7.873-7.873a4 4 0 0 0-2.872-1.172" />
  </svg>
);
...
export const SyncIcon: React.FC<{ className?: string, title?: string }> = ({ className, title }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <title>{title}</title>
...
const UpiIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M3 10V9a1 1 0 0 1 1-1h1"/>
      <path d="M3 14v1a1 1 0 0 0 1 1h1"/>
      <path d="M8 7H7a1 1 0 0 0-1 1v1"/>
      <path d="M8 17H7a1 1 0 0 1-1-1v-1"/>
      <path d="M21 10V9a1 1 0 0 0-1-1h-1"/>
      <path d="M21 14v1a1 1 0 0 1-1 1h-1"/>
      <path d="M16 7h1a1 1 0 0 1 1 1v1"/>
      <path d="M16 17h1a1 1 0 0 0 1-1v-1"/>
      <path d="M8 12h8"/>
      <path d="M12 8v8"/>
    </svg>
);

const GenericPaymentIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <circle cx="12" cy="12" r="10" />
        <path d="M12 6v12" />
        <path d="M17.196 9H6.804a1 1 0 0 0-.866 1.5L9 15" />
    </svg>
);

export const PaymentMethodIcon: React.FC<{ iconName?: PaymentTypeIcon, className?: string }> = ({ iconName, className }) => {
    switch(iconName) {
        ...
        case 'generic':
        default: return <GenericPaymentIcon className={className} />;
    }
};
